...
const CsvUpload = () => {
  ...
  const userSubmissions = getUserSubmissions().filter(sub => sub.type === 'csv');
  ...
  const handleFileSelect = (e) => {
    ...
    if (file) {
      if (file.type === 'text/csv' || file.name.endsWith('.csv')) {
        ...
        if (!uploadForm.title) {
          setUploadForm(prev => ({ ...prev, title: file.name.replace('.csv', '') }));
        }
      } else {
  ...
  const handleSubmitFile = () => {
    ...
    toast('CSV file submitted', {
      description: 'Your CSV file has been sent to the admin for review.'
    });
  };
    ...
    <DashboardLayout>
      <div className="p-6">
        <div className="flex justify-between items-center mb-6">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">CSV Uploads</h1>
            <p className="text-gray-600">Upload and manage CSV data files</p>
          </div>
          ...
          <Dialog open={isUploadDialogOpen} onOpenChange={setIsUploadDialogOpen}>
            ...
            <DialogContent className="max-w-2xl">
              ...
              <div className="space-y-4">
                <div>
                  <Label htmlFor="file">CSV File (.csv)</Label>
                  <Input
                    id="file"
                    type="file"
                    accept=".csv,text/csv"
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="Describe the CSV data and its intended use"
                    rows={3}
                  />
                </div>
          ...
          {userSubmissions.length === 0 ? (
            <Card>
              <CardContent className="text-center py-8">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">No CSV files uploaded yet</h3>
